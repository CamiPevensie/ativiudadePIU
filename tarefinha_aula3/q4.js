...
let nome = prompt('Escreva seu nome, sinhô(ou sinhora): ') //aqui o bonito ou bonita escreve o 
// nome no cmd
...
disney = (disney.toLowerCase() === 'true'); // transforma o que o usuario respondeu em booleano; 
// também poderia ser disney = (disney === "true"), mas não é tão seguro quanto o que eu escrevi

let dados_pessoa = { //aqui criamos o grande dicionário, onde pomos as informações que, nesse caso, 
// são da pessoa
    nome: nome,
    idade: idade,
    disney: disney
